...
public class Robot extends TimedRobot {
  ...
  private PWMVictorSPX intake = new PWMVictorSPX(4);
  private PWMVictorSPX FL = new PWMVictorSPX(0); // 0
  private PWMVictorSPX FR = new PWMVictorSPX(1); // 1
  private PWMVictorSPX BL = new PWMVictorSPX(2); // 2
  private PWMVictorSPX BR = new PWMVictorSPX(3);
  ...
  public void teleopPeriodic(){
    ...
    double intakespeed = joy1.getRawAxis(2);
